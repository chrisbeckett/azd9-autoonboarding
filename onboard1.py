...
def list_subscriptions():
    try:
        for sub in sub_client.subscriptions.list():
            ...
            payload = {'name':sub.display_name,'subscriptionId':sub.subscription_id,'tenantId':az_tenant,'credentials': {'clientId':az_appid,'clientPassword':az_appkey},'operationMode':'Read','vendor':'azure'}
            ...
            if r.status_code == 201:
                ...
                print('There was an error with the subscription, please check credentials and that it does not already exist in Dome9:',sub.subscription.id)
